...
class WelcomePageWidgetsCreator(WidgetsCreator):
    ...
    def _switch_page_button(self):
        self.navigator.navigate_to_next_page()
    ...
    def bottom_layout_widgets(self):
        self._create_standard_button(self._list_of_bottom_layout_widgets, " Start App", 120, 40, 10, "start_button",
                                     "./resource/start.svg", self._switch_page_button)
